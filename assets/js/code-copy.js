...
document.addEventListener('DOMContentLoaded', function () {
    ...
    /* Custom button */
    document.querySelectorAll('.full-code-copy').forEach(function (button) {
          // Add copy and success icons
          ...
          button.addEventListener('click', function (e) {
            ...
            realButtons = document.querySelectorAll('.code-copy-btn');
      
            if (realButtons.length == 0) {
              return;
            }
      
            realButton = realButtons[0];
      
            // Get the code target
            const target = realButton.parentElement.previousElementSibling;
            let codeElement;
            if (target.tagName === 'CODE') {
              codeElement = target;
            } else {
